...
//        $this->positionCreator = $positionCreator;
    ...
    /**
     * Returns an array of TOP applications from the PlayMarket for the specified category.
     */
    final public function execute(
        ...
        $rating = mb_strtoupper(Position::RATING_TYPE_CATEGORY_TOP);
        ...
        try {
            /** @var App[] */
            $topApps = $this->playMarket
                ->setTimeout(5)
                ->setDefaultLocale($locale)
                ->setDefaultCountry($country)
                ->setProxy($proxy)
                ->getTopApps($category, $ageCriteria, $limit);
        } catch (\Throwable $e) {
